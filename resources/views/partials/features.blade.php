    ...
    <div class="mt-16 grid text-gray-600 grid-cols-12 gap-6">
      ...
      <div class="max-w-[210px] gap-4 2xl:mx-10 relative space-y-8 py-12 p-8 col-span-7 min-h-[382px]">
        ...
        <img
            ...
            class="absolute w-45 shadow-xl transition delay-150 duration-300 ease-in-out hover:-translate-y-5 hover:scale-120"
            alt="invoice"
          />
          <img
            src="/wp-content/themes/sputnik/resources/images/invoice2.png"
            class="absolute bottom-[40px] right-[0] w-45 shadow-xl transition delay-150 duration-300 ease-in-out hover:-translate-y-5 hover:scale-120"
            alt="burger illustration"
          />
...
<!--three blocks-->
      ...
      <div class="col-span-4 rounded-2xl group relative bg-[#e1ecef] transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10"
      >
        <div
          class="relative space-y-8 py-12 p-8 transition duration-300 group-hover:bg-white dark:group-hover:bg-gray-800"
        >
