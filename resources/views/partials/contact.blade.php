    ...
    <div class="max-w-7xl mx-auto px-6 md:px-12 xl:px-6">
      <div class="relative">
        ...
        <div class="mt-6 m-auto space-y-6 md:w-8/12 lg:w-7/12">
          <h1 class="text-center text-4xl font-bold text-gray-800 dark:text-white md:text-5xl">Get Started <span class="text-primary">Right Now</span></h1>
          <p class="text-center text-xl text-gray-600 dark:text-gray-300">
            Book a 30-minute, no-obligation conversation and I'll help you figure out what you need.
          </p>
