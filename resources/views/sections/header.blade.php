...
<nav id="shortHead" class="w-full z-10 relative">
        <div class="w-full max-w-7xl mx-auto px-0 lg:px-12 xl:px-6">
            <div class="flex flex-wrap items-center justify-between py-2 gap-6 md:py-4 md:gap-0 relative">
                <div class="relative z-20 w-full inline-block justify-between lg:w-max md:px-0">
                    <a href="#home" aria-label="logo" class="space-x-2 items-center">
                      <div aria-hidden="true" class="inline-block float-left space-x-1">
                    ...
                    <div class="justify-self-end relative flex items-center lg:hidden max-h-10">
                        <label role="button" for="navMenu" aria-label="hamburger" id="hamburger" class="relative p-6">
                ...
                <div id="navMenu" class="flex-col z-20 flex-wrap gap-6 p-8 rounded-bl-3xl bg-white shadow-2xl shadow-gray-600/10 justify-end w-auto invisible opacity-0 absolute top-full right-0 transition-all duration-300 origin-top 
                    ...
                    <div class="text-gray-600 lg:pr-4 lg:w-auto w-full lg:pt-0">
